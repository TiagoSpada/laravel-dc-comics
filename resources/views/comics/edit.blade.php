        ...
        <div class="container">
            ...
            <form action="{{ route('comics.update', $comics->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="descrizione" style="height: 100px" name='description'>{{ old('description', $comics['description']) }}</textarea>
                </div>
                {{-- IMMAINE --}}
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="data-vendita" name="sale_date"
                        placeholder="yyyy/mm/dd" value="{{ old('sale_data', $comics['sale_date']) }}">
                </div>
                {{-- TIPO --}}
                <div class="mb-3">
                    ...
                    <select class="form-select" id="tipo" aria-label="Default select example" name="type">
                        ...
                        <option value="graphic novel" @if ($comics->type === 'graphic novel') selected @endif>graphic novel
                        </option>
                    </select>
                </div>
                {{-- ARTISTI --}}
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="artisti" name="artists"
                        value="{{ old('artist', $comics->artists) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="autore" name="writers"
                        value="{{ old('writers', $comics->artists) }}">
                    <div id="emailHelp" class="form-text">inserire i dati come in un array</div>
                </div>
